...
- **New environment variables** (additive, no renames): `REDIS_LOCK_TTL`, `WORKER_CONCURRENCY`, `RABBITMQ_RETRY_QUEUE`, `RABBITMQ_DLQ`, `RATE_LIMIT_ENABLED`, `RATE_LIMIT_WINDOW_SECONDS`, `RATE_LIMIT_MAX_REQUESTS`, `RATE_LIMIT_AUTH_MAX_REQUESTS`, `RATE_LIMIT_AUTH_WINDOW_SECONDS`, `RETRY_MAX_ATTEMPTS`, `RETRY_INITIAL_DELAY`.
