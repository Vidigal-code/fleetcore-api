...
@Module({
  ...
  providers: [UnitOfWork, RedisService, RepositoryCacheService, AppConfigService, FeatureToggleService, FeatureFlagGuard, EventBusService, ResilienceService, DomainMetricsService],
  exports: [UnitOfWork, RedisService, RepositoryCacheService, AppConfigService, FeatureToggleService, FeatureFlagGuard, EventBusService, ResilienceService, DomainMetricsService],
})
