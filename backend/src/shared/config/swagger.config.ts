    ...
    documents: [
      {
        ...
        description: [
          ...
          '2. O `accessToken` é aplicado automaticamente no **Authorize** — já dá para testar as rotas protegidas em sequência. (Opcional: copie o token e cole no cadeado.)',
      ...
      },
      {
        ...
        description: [
          ...
          '2. The `accessToken` is applied to **Authorize** automatically — protected routes are ready to test in sequence. (Optional: copy it and paste in the lock icon.)',
